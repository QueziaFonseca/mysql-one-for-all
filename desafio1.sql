...
-- Popula tabela user
INSERT INTO
  SpotifyClone.user (user_id, user_name, plan_id, age, signature_date)
VALUES
  (1, 'Thati', 1, 23, '2019-10-20'),
  (2, 'Cintia', 2, 35, '2017-12-30'),
  (3, 'Bill', 3, 20, '2019-06-05'),
  (4, 'Roger', 4, 45, '2020-05-13'),
  (5, 'Norman', 4, 58, '2017-02-17'),
  (6, 'Patrick', 2, 33, '2017-01-06'),
  (7, 'Vivian', 3, 26, '2018-01-05'),
...
VALUES
  ...
  (8, "Sweetie, Let's Go Wild", 139, 2, 2),
  (9, 'She Knows', 244, 3, 2),
